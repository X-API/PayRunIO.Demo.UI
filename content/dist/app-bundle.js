...
define('employer/employer',["exports", "aurelia-framework", "aurelia-event-aggregator", "aurelia-http-client", "aurelia-dialog", "../pay-schedule/pay-schedule-modal", "../pension/pension-modal", "../dialogs/confirm"], function (exports, _aureliaFramework, _aureliaEventAggregator, _aureliaHttpClient, _aureliaDialog, _payScheduleModal, _pensionModal, _confirm) {
    "use strict";
        ...
        Employer.prototype.openPensionModal = function openPensionModal(pension) {
            ...
            this.dialogService.open(opts).whenClosed(function (response) {
                if (!response.wasCancelled) {
                    ...
                    _this4.getEmployerDetails(_this4.employer.Id);
                }
            });
        };
