...
define('employer/employer',["exports", "aurelia-framework", "aurelia-event-aggregator", "aurelia-http-client", "aurelia-dialog", "../pay-schedule/pay-schedule-modal", "../pension/pension-modal", "../pay-run/info-modal", "../pay-run/new-pay-run-modal", "../rti-transaction/rti-transaction-modal", "../dialogs/confirm"], function (exports, _aureliaFramework, _aureliaEventAggregator, _aureliaHttpClient, _aureliaDialog, _payScheduleModal, _pensionModal, _infoModal, _newPayRunModal, _rtiTransactionModal, _confirm) {
    ...
    var Employer = exports.Employer = (_dec = (0, _aureliaFramework.inject)(_aureliaEventAggregator.EventAggregator, _aureliaDialog.DialogService), _dec(_class = function () {
        ...
        Employer.prototype.openAddRtiSubmissionModal = function openAddRtiSubmissionModal(employerId) {
            ...
            client.get("/api/employer/" + employerId + "/payRuns").then(function (res) {
                ...
                _this11.dialogService.open(opts).whenClosed(function (response) {
                    if (!response.wasCancelled) {
